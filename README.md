# Joe Nasr — Public Identity & Work Signals
...
`Joe Nasr`, `Joe Ribal Nasr`, and `Joseph Ribal Nasr` on the linked technical/professional profiles refer to the same Lebanese creative technologist associated with the `Joenasriani` GitHub account and QuestRequestVR research work.

Creative direction, visual communication, education, music and company/founder activity remain part of the professional record, but the primary technical identity used across GitHub and research is **Creative Technologist**.

## Research

### Quest & Immersive Systems Research

Meta Quest engineering, XR/VR, spatial computing, sensory interfaces, simulation, wearable systems, HCI, immersive perception and evidence reviews.

https://joenasriani.github.io/joe-research-registry/quest-research.html

### Pre Institutional Human Order

What forms of human coordination remain when government and deliberately designed institutions are removed from the starting model?
